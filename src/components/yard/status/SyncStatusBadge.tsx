...
export function SyncStatusBadge() {
  ...
  if (!mounted) {
    return (
      <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-sm border bg-white/10 text-white/70 border-white/10 min-w-[72px]">
  ...
  return (
    <div className={`flex items-center gap-1.5 px-2 py-0.5 rounded-sm border ${TONE_CLS[tone]}`}>
