...
export { REQUIREMENTS_BY_TYPE, SCHOOL_REQS } from "@/domain/equipment/requirements-catalog";
export { isValidVehicleEquipment } from "@/domain/equipment/equipment-shape";
export type { StockLine } from "@/types/equipment";
