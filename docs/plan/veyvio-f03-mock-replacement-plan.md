...
**Status:** Exec Gate 0–1 Done (code) · Exception writes Done · Compliance due-item read + website persist-first Done (code) · Equipment inventory writes + KV bind/deploy + quarantine still open  
