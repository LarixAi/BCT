...
**Severity:** P1 HIGH  
**Status:** IN PROGRESS — batches: `fuel-records`, `adblue-records`, `depot-stock`, `equipment-assets`, `tyre-assets`, `purchase-requests`, `defect-damage-link`, `dispatch-assignment-gates`, `driver-write-guards`, `incident-workflow`, `journey-sequence-reorder`; 33 company-scoped modules remain  
