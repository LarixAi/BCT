...
> = {
  ...
  driver_app: {
    ...
    estimatedMinutes: 20,
    mandatory: true,
    eligibilityEffect: 'warning',
    restrictedWorkTypes: [],
    requiresEvidence: false,
  },
  daily_vehicle_checks: {
    label: 'Daily vehicle checks',
    category: 'Driver and vehicle safety',
    requiredFor: 'All drivers',
    renewalMonths: 12,
    estimatedMinutes: 20,
    mandatory: true,
  ...
  safeguarding_adults: {
    ...
    category: 'Passenger safeguarding',
    requiredFor: 'All drivers',
    renewalMonths: 36,
    estimatedMinutes: 30,
    mandatory: true,
    eligibilityEffect: 'block_specific_work',
    restrictedWorkTypes: ['vulnerable_adults', 'hospital'],
    requiresEvidence: true,
  },
  first_aid_efaw: {
  ...
  wheelchair_restraint: {
    ...
    category: 'Wheelchair securement',
  ...
  lift_ramp_operation: {
    ...
    category: 'Passenger lift operation',
  ...
  send_autism_awareness: {
    ...
    category: 'SEND transport awareness',
  ...
  behaviour_management: {
    ...
    category: 'Behaviour and conflict management',
  ...
  dementia_awareness: {
    ...
    category: 'Vulnerable adult safeguarding',
