...
const TRACKED_DEBT = new Map([
  ...
  ['src/features/journey-sequence/JourneySequencePanel.tsx', 'journey sequence reorder/move live via Command API; mock upsert only when VITE_MOCK_API=true'],
  ['src/features/journey-sequence/MoveJourneyPanel.tsx', 'journey move live via Command API; ack still mock-only'],
