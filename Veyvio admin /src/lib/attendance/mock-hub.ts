...
const leaveSeed: LeaveRequestRecord[] = [
  ...
  {
    id: 'leave-jane-pending',
    reference: 'LR-00030',
    personId: 'drv-1',
    personName: 'Jane Smith',
    personNumber: 'DRV-0001',
    role: 'driver',
    depotName: 'Croydon',
    leaveType: 'annual_leave',
    status: 'pending',
    ...
    endTime: null,
    partialDay: false,
    reason: 'School holiday week with family',
    attachmentLabel: null,
    submittedAt: isoToday(10, 5),
    decidedAt: null,
    decidedBy: null,
    impact: {
      tripsAffected: 4,
      ...
      readinessPercent: 80,
      readinessBand: 'medium',
      readinessSummary: 'Cover available if approved with notice.',
    },
    audit: [
      {
        id: 'la-jane-1',
