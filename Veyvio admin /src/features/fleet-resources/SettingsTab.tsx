...
export function SettingsTab({ hub }: { hub: FleetResourcesHubData }) {
  ...
  return (
    <div className="max-w-xl space-y-4">
      <div>
        <h2 className="text-lg font-semibold text-ink">Resource policies</h2>
      ...
      <label className="block text-sm">
        <span className="mb-1 block font-medium text-ink-soft">Require receipt above (£)</span>
        <input
          type="number"
      ...
      <label className="block text-sm">
        <span className="mb-1 block font-medium text-ink-soft">Max litres per transaction</span>
        <input
          type="number"
      ...
      <label className="block text-sm">
        <span className="mb-1 block font-medium text-ink-soft">Manager approval above (£)</span>
        <input
          type="number"
      ...
      <label className="block text-sm">
        <span className="mb-1 block font-medium text-ink-soft">Company MPG baseline</span>
        <input
          type="number"
          step="0.1"
      ...
      <label className="block text-sm">
        <span className="mb-1 block font-medium text-ink-soft">Minimum tread depth (mm)</span>
        <input
          type="number"
          step="0.1"
      ...
      <label className="block text-sm">
        <span className="mb-1 block font-medium text-ink-soft">Low fuel warning (%)</span>
        <input
          type="number"
