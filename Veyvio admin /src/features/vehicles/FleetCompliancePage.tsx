  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-2 text-2xl font-semibold text-slate-900">Compliance calendar</h1>
        <p className="text-sm text-slate-600">Fleet-wide certificate and test expiry timeline</p>
      </div>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody>
              {items.map((item, i) => {
                ...
                return (
                  <tr key={`${item.vehicle.id}-${item.label}-${i}`} className="border-b border-slate-50">
