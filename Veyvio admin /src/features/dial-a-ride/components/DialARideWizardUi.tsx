...
import { DIAL_A_RIDE_STEPS } from '@/lib/dial-a-ride/constants'

export function DialARideStepper({
  currentStep,
  onStepClick,
}: {
  currentStep: number
  ...
  return (
    <nav aria-label="Dial-a-Ride progress" className="overflow-x-auto">
      <ol className="flex min-w-max gap-1">
        {DIAL_A_RIDE_STEPS.map((step) => {
